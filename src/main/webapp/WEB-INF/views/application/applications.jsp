            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <a href="/predictivemaintenancelist" class="small-box-footer">
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        ...
                        <a href="/devicemonitoringlist" class="small-box-footer">
                            进入 <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
