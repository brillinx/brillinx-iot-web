...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                批量数据接入管理
                <small>批量数据接入列表</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">数据接入</a></li>
                <li><a href="#">批量数据接入</a></li>
                <li class="active">批量数据接入列表</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">批量数据接入列表</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <table id="dataList" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <c:forEach var="batchDataConnectionItem" items="${batchDataConnectionList}">
                                        <tr>
                                            <td>${batchDataConnectionItem.id}</td>
                                            <td>${batchDataConnectionItem.batchDataConnectionName}</td>
                                            <td>${batchDataConnectionItem.batchDataConnectionComments}</td>
                                            <td>
                                                <c:if test="${batchDataConnectionItem.status == 'stopped'}">
                                                    <span class="label label-warning">停止</span>
                                                </c:if>
                                                <c:if test="${batchDataConnectionItem.status == 'running'}">
                                                    <span class="label label-success">运行中</span>
                                                </c:if>
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-block btn-primary" onclick="getBatchDataConnectListItemDetails()">详情</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    <%--<tr>
