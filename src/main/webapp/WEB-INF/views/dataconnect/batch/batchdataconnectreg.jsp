...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                新建批量数据接入
                <small>新建批量数据接入</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">数据接入</a></li>
                <li><a href="#">实时数据接入</a></li>
                <li class="active">新建批量数据接入</li>
            </ol>
        </section>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <table>
                                <tr>
                                    <td>
                                        <label for="batchDataConnectIdentifier">输入数据接入标识</label>
                                    </td>
                                    <td>
                                        <input type="input" class="form-control" id="batchDataConnectIdentifier" placeholder="输入">
                                    </td>
                                </tr>

                                <tr>
                                    <td>
                                        <label for="device-type-select-list">选择设备类型</label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="input" class="form-control" id="filename" placeholder="选择">
                                    </td>

                                    <td>
                                        <div class="file-upload">
                                            <%--<button type="button" class="btn btn-block btn-primary" id="chooseFile">上传数据文件</button>--%>
                                            <div class="select-file" id="selectFile">
                                                <div id="chooseFile" class="chooseFile">上传数据文件</div>
                                            </div>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-block btn-primary">预览文件内容</button>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div class="form-group">
                            <label for="batchDataConnectComments">备注</label>
                            <input type="input" class="form-control" id="batchDataConnectComments" placeholder="输入">
                        </div>
                        <table>
                            <tr>
                                <td>
                                    <button type="button" class="btn btn-block btn-primary" onclick="submitCreateBatchDataConnect()">提交</button>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-block btn-primary" onclick="cancelCreateBatchDataConnect()">取消</button>
                                </td>
                            </tr>
                        </table>
                    </div>
...
<!-- batch-data-connect.js -->
<script src="resources/js/batch-data-connect.js"></script>
...
//					$('#imagePath').val(response.imagePath);
                    ...
                    queueItem.delay(500).fadeOut(500, function() {
                        $(this).remove();
                        $(picker).show();
//						showImg(response.imagePath);
                        saleData = response.result;
                    });
                    swal("文件上传成功");
                }else{
                    swal("操作失败", response.result, "error");
                    queueItem.delay(500).fadeOut(500, function() {
                        $(this).remove();
                        $(picker).show();
                        refresh();
