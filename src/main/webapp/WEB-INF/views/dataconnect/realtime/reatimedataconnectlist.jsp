...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                实时数据接入管理
                <small>实时数据接入列表</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">数据接入</a></li>
                <li><a href="#">实时数据接入</a></li>
                <li class="active">实时数据接入列表</li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <table id="dataList" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <c:forEach var="realtimeDataConnectionItem" items="${realtimeDataConnectionList}">
                                        <tr>
                                            <td>${realtimeDataConnectionItem.id}</td>
                                            <td>${realtimeDataConnectionItem.deviceModelName}</td>
                                            <td>${realtimeDataConnectionItem.realtimeDataConnectionComments}</td>
                                            <td>
                                                <c:if test="${realtimeDataConnectionItem.status == 'stopped'}">
                                                    <span class="label label-warning">停止</span>
                                                </c:if>
                                                <c:if test="${realtimeDataConnectionItem.status == 'running'}">
                                                    <span class="label label-success">运行中</span>
                                                </c:if>
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-block btn-primary" onclick="getReatimeDataConnectListItemDetails()">详情</button>
                                            </td>
                                            <td>

                                                <button type="button" class="btn btn-block btn-success">启动</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    ...
                                    <%--<tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block btn-primary">详情</button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block btn-warning">停止</button>
                                        </td>
                                    </tr>--%>
...
<!--static dialog-->
<div id="details-dialog-message" title="详情">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Data Table With Full Features</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body" id="details_result_div">
            <%--<table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th>deviceModelId</th>
                        <th>propertyName</th>
                        <th>propertyComments</th>
                        <th>propertyValueRangeId</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
