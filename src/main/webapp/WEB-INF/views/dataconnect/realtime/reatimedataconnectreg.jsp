...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                新建设备数据接入
                <small>新建设备数据接入</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">数据接入</a></li>
                <li><a href="#">实时数据接入</a></li>
                <li class="active">新建设备数据接入</li>
            </ol>
        </section>
        ...
        <section class="content">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <table>
                                <tr>
                                    <td>
                                        <label for="realtimeDataConnectIdentifier">数据接入标识</label>
                                    </td>
                                    <td>
                                        <input type="input" class="form-control" id="realtimeDataConnectIdentifier" placeholder="输入">
                                    </td>
                                </tr>

                                <tr>
                                    <td>
                                        <label for="realtimeDataConnectIdentifier">选择设备类型</label>
                                    </td>
                                    <td>
                                        <select class="form-control select2" style="width: 100%;" id="device-type-select-list">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-block btn-primary" onclick="showDeviceInfoConfig()">查看设备信息配置</button>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div class="form-group">
                            <label for="realtimeDataConnectComments">备注</label>
                            <input type="input" class="form-control" id="realtimeDataConnectComments" placeholder="输入">
                        </div>
                        <table>
                            <tr>
                                <td>
                                    <button type="button" class="btn btn-block btn-primary" onclick="generateDataConnectInfo()">生成数据接入信息</button>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-block btn-primary" onclick="clearDeviceDataConnectInfo()">清空</button>
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">设备接入API及Token</h3>
                                ...
                                <!-- /.box-header -->
                                <div class="box-body table-responsive no-padding" id="api_token_list_result_div">
                                    <%--<table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>https://12.33.3.3/token?</td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>上传数据点</td>
                                            <td><span class="label label-warning">POST</span></td>
                                            <td>https://12.33.3.3/data?token=?</td>
                                        </tr>
                                    </table>--%>
                                </div>
                                <!-- /.box-body -->
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">下载设备接入SDK</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-3">
                            <button type="button" class="btn btn-block btn-success">Java JDK</button>
                        </div>
                        <div class="col-xs-4">
                            <button type="button" class="btn btn-block btn-success">C Lib</button>
                        </div>
                        <div class="col-xs-5">
                            <button type="button" class="btn btn-block btn-success">C++ Lib</button>
                        </div>
...
<!-- device-list.js -->
<%--<script src="resources/js/device-list.js"></script>--%>
<!-- data-connect.js -->
<script src="resources/js/data-connect.js"></script>
