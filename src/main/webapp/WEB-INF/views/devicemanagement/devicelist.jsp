            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body" id="result_div">
                            ...
                            <table id="dataList" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <%--<tr>
                                        ...
                                        <td>相关介绍</td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-primary device_attribute_modal_link">设备属性</button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-block btn-danger">删除设备</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>ASFEFSFFSF</td>
