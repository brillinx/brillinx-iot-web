...
<head>
    ...
    <title>BrillinX | Dashboard</title>
                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs pull-right">
                            ...
                            <li class="pull-left header"><i class="fa fa-inbox"></i> 接入数据量(GB)</li>
                        </ul>
...
<%--                            <div class="chart tab-pane" id="sales-chart" style="position: relative; height: 300px;">
                                <!-- Donuts 图形 -->
                                <div id="donuts" style="position: relative; height: 300px;width: 600px;"></div>
                            </div>--%>
                        </div>
                    </div>
                    <!-- /.nav-tabs-custom -->
                ...
                <section class="col-lg-5 connectedSortable">
                    ...
                    <div class="box box-solid bg-light-blue-gradient">
                        ...
                        <div class="box-body">
                            <div id="chinamap" style="height: 400px; width: 400px;"></div>
                        </div>
                        <%--<div class="box-body">--%>
                        ...
                        <div class="box-footer no-border">
                            <div class="row">
                                ...
                                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                                    ...
                                    <div class="knob-label">数据量</div>
                                </div>
                                <!-- ./col -->
                                <div class="col-xs-4 text-center">
                                    <div id="sparkline-3"></div>
                                    <div class="knob-label">用户数</div>
                                </div>
                                <!-- ./col -->
                            </div>
                            <!-- /.row -->
...
<!-- jQuery UI 1.11.4 -->
<script src="resources/code.jquery.com/ui/1.11.4/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="resources/cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
...
<!-- daterangepicker -->
<script src="resources/cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.6/moment.min.js"></script>
...
<script type="text/javascript" src="resources/echarts-2.2.7/build/dist/echarts.js"></script>
<!--饼图-->
<%--<script src="resources/js/donus_example.js"></script>--%>
<!-- 中国地图-->
<%--<script src="resources/js/china.js"></script>--%>
<%--<script src="resources/echarts3/china.json"></script>--%>
<!--样本数据-->
<%--<script src="resources/js/map_example.js"></script>--%>
<!--dashboard-->
<script src="resources/js/dashboard-data.js"></script>
<!--highcharts-->
